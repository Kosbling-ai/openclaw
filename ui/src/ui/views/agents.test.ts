...
function createProps(overrides: Partial<AgentsProps> = {}): AgentsProps {
  return {
    ...
    agentIdentityById: {},
    agentIsolationGuardrailLoading: false,
    agentIsolationGuardrailError: null,
    agentIsolationGuardrailStatus: null,
    agentSkills: {
      report: null,
      loading: false,
      error: null,
    ...
    onIsolationGuardrailRefresh: () => undefined,
    onIsolationGuardrailDisable: () => undefined,
